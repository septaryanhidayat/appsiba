...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 2. Settings (APPSI Banyuasin SK 2026-2031)
        $settings = [
            ...
            'alamat' => 'Jalan Merdeka, Kelurahan Pangkalan Balai - Kecamatan Banyuasin III, Kabupaten Banyuasin, Sumatera Selatan (30914)',
        ...
        // 3. Organization Structures (SK DPW APPSI SUMSEL No: 012/SK/DPW-APPSI/VI/2026)
        OrganizationStructure::query()->delete();
        $orgData = [
            // 1. DEWAN PENASEHAT
            [
                'nama' => 'DR. H. ASKOLANI, SH, MH.',
                'jabatan' => 'Dewan Penasehat (Bupati Banyuasin)',
                'divisi' => 'Dewan Penasehat',
                'urutan' => 1,
                'periode' => '2026 - 2031',
            ...
            [
                'nama' => 'NETA INDIAN, SP.',
                'jabatan' => 'Dewan Penasehat (Wakil Bupati Banyuasin)',
                'divisi' => 'Dewan Penasehat',
                'urutan' => 2,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
            ...
            // 2. DEWAN PEMBINA
            [
                'nama' => 'Drs. H. AMIRUNAS, M.Pd.I.',
                'jabatan' => 'Dewan Pembina',
                'divisi' => 'Dewan Pembina',
                'urutan' => 5,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => null,
            ...
            // 3. DEWAN PIMPINAN DAERAH (PENGURUS HARIAN)
            [
            ...
            [
                ...
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => '0812-7301-4422',
                'email' => 'wardoyo@appsiba.or.id',
            ],
            [
                'nama' => 'H. SYAMSIR SIKUMBANG, S.Ag, M.Si.',
                'jabatan' => 'Sekretaris',
                'divisi' => 'Sekretariat',
                'urutan' => 9,
                'periode' => '2026 - 2031',
                ...
                'email' => 'syamsir.sikumbang@appsiba.or.id',
            ],
            [
                'nama' => 'M. WILDHANI RAYHAN',
                ...
                'email' => 'wildhani.rayhan@appsiba.or.id',
            ],
            [
                'nama' => 'H. RAHMAN, S.Kom',
                'jabatan' => 'Bendahara',
            ...
            [
                ...
                'email' => 'ridho.andi@appsiba.or.id',
            ],

            // 4. BIDANG - BIDANG
            [
                'nama' => 'MUKHLASIN',
                'jabatan' => 'Ketua Bidang Organisasi dan OKK',
                'divisi' => 'Bidang Organisasi dan OKK',
                'urutan' => 13,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => '0813-6800-4411',
                'email' => 'mukhlasin@appsiba.or.id',
            ],
            [
                'nama' => 'HASNATUL NADIA, S.Pd',
                'jabatan' => 'Ketua Bidang Ekonomi dan Usaha',
                'divisi' => 'Bidang Ekonomi dan Usaha',
                'urutan' => 14,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => '0813-7766-5544',
                'email' => 'hasnatul.nadia@appsiba.or.id',
            ],
            [
                'nama' => 'JHONI ARYADI',
                'jabatan' => 'Ketua Bidang Pemberdayaan Masyarakat',
                'divisi' => 'Bidang Pemberdayaan Masyarakat',
                'urutan' => 15,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => '0853-8822-1133',
                'email' => 'jhoni.aryadi@appsiba.or.id',
            ],
            [
                'nama' => 'SLAMET CHANIAGO, SH',
                'jabatan' => 'Ketua Bidang Audit Internal',
                'divisi' => 'Bidang Audit Internal',
                'urutan' => 16,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => '0821-9988-7711',
                'email' => 'slamet.chaniago@appsiba.or.id',
            ],
            [
                'nama' => 'Hj. ERA YULIA',
                'jabatan' => 'Ketua Bidang Peranan Wanita',
                'divisi' => 'Bidang Peranan Wanita',
                'urutan' => 17,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => '0812-7722-3344',
                'email' => 'era.yulia@appsiba.or.id',
            ],
            [
                'nama' => 'AMRIZAL',
                'jabatan' => 'Ketua Bidang Hubungan Antar Lembaga',
                'divisi' => 'Bidang Hubungan Antar Lembaga',
                'urutan' => 18,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => '0813-8833-2211',
                'email' => 'amrizal@appsiba.or.id',
            ],
            [
                'nama' => 'APRIZAL',
                'jabatan' => 'Ketua Bidang Hukum dan Humas',
                'divisi' => 'Bidang Hukum dan Humas',
                'urutan' => 19,
                'periode' => '2026 - 2031',
                'foto' => 'assets/images/default-avatar-gray.png',
                'no_hp' => '0852-7711-9900',
                'email' => 'aprizal@appsiba.or.id',
            ],
        ];
        ...
        $posts = [
            [
                ...
                'gambar' => 'assets/images/berita/berita-qris-digital.webp',
                'status' => 'published',
                'views_count' => 428,
            ...
            [
                ...
                'gambar' => 'assets/images/berita/berita-operasi-pasar.webp',
                'status' => 'published',
                'views_count' => 389,
            ...
            [
                ...
                'gambar' => 'assets/images/berita/berita-permodalan-kur.webp',
                'status' => 'published',
                'views_count' => 312,
            ...
            [
                ...
                'gambar' => 'assets/images/berita/berita-pasar-sungsang.webp',
                'status' => 'published',
                'views_count' => 276,
            ...
            [
                ...
                'gambar' => 'assets/images/berita/berita-musyawarah-appsi.webp',
                'status' => 'published',
                'views_count' => 354,
            ...
            [
                ...
                'gambar' => 'assets/images/berita/munas-appsi.webp',
                'status' => 'published',
                'views_count' => 512,
        ...
        $galleries = [
            [
                ...
                'foto' => 'assets/images/berita/berita-qris-digital.webp',
                'kategori' => 'Digitalisasi Pasar',
            ...
            [
                ...
                'foto' => 'assets/images/berita/berita-operasi-pasar.webp',
                'kategori' => 'Stabilisasi Pangan',
            ...
            [
                ...
                'foto' => 'assets/images/berita/berita-permodalan-kur.webp',
                'kategori' => 'Permodalan KUR',
            ...
            [
                ...
                'foto' => 'assets/images/berita/berita-pasar-sungsang.webp',
                'kategori' => 'Advokasi Pasar',
            ...
            [
                ...
                'foto' => 'assets/images/berita/berita-musyawarah-appsi.webp',
            ...
            [
                ...
                'foto' => 'assets/images/berita/kegiatan-timbangan-tera.webp',
            ...
            [
                ...
                'foto' => 'assets/images/berita/kegiatan-pelatihan-wanita.webp',
